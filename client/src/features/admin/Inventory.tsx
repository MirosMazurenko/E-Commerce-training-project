...
import { productSelectors, fetchProductsAsync, fetchFilters, setPageNumber, removeProduct } from "../catalog/catalogSlice";
                        ...
                        {products.map((product) => (
                            ...
                            >
                                ...
                                <TableCell align="right">
                                    ...
                                    <LoadingButton
                                        loadingIndicator={loading && target === product.id}
                                        startIcon={<Delete />}
                                        color='error'
